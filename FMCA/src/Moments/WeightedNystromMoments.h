...
//
#ifndef FMCA_MOMENTS_WEIGHTEDNYSTROMMOMENTS_H_
#define FMCA_MOMENTS_WEIGHTEDNYSTROMMOMENTS_H_

namespace FMCA {
template <typename Interpolator>
class WeightedNystromMoments {
 public:
  WeightedNystromMoments(const Matrix &P, const std::vector<Scalar> &w,
                         Index polynomial_degree = 3)
      : P_(P), polynomial_degree_(polynomial_degree) {
    interp_.init(P_.rows(), polynomial_degree_, w);
  }
  //////////////////////////////////////////////////////////////////////////////
