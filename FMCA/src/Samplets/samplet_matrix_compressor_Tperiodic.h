...
//
#ifndef FMCA_SAMPLETS_SAMPLETMATRIXCOMPRESSORTPERIODIC_H_
#define FMCA_SAMPLETS_SAMPLETMATRIXCOMPRESSORTPERIODIC_H_
...
class SampletMatrixCompressorTperiodic {
 public:
  SampletMatrixCompressorTperiodic() {}
  SampletMatrixCompressorTperiodic(const SampletTreeBase<Derived> &ST,
...
#pragma omp critical
 ...
 private:
  ...
  Matrix recursivelyComputeBlock(const Derived &TR, const Derived &TC,
    ...
    if (compareClusterTPeriodic(TR, TC, eta_) == LowRank) {
