...
#pragma omp parallel for
  ...
  std::vector<Eigen::Triplet<Scalar>> aposteriori_triplets_fast(const Scalar thres) {
  ...
  std::vector<Eigen::Triplet<Scalar>> aposteriori_triplets(const Scalar thres) {
    std::vector<Eigen::Triplet<Scalar>> triplets = triplet_list_;
    ...
    {
      struct comp {
        comp(const std::vector<Eigen::Triplet<Scalar>> &triplets) : ts_(triplets) {}
        ...
        const std::vector<Eigen::Triplet<Scalar>> &ts_;
      };
