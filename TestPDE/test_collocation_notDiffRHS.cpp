...
int main() {
  ...
  FMCA::Matrix P;
  //////////////////////////////////////////////////////////////////////////////
  readTXT("data/interior_square.txt", P_sources, 2);
  readTXT("data/boundary_square.txt", P_sources_border, 2);
  readTXT("data/InteriorAndBnd_square.txt", P, 2);
...
//             << std::endl;
  ...
  FMCA::IO::print2m("results_matlab/solution_collocation_notDiffRHS.m", "sol_collocation_notDiffRHS", Kalpha, "w");
...
//   FMCA::IO::print2m("error_collocation_absolute.m", "absolute_error_collocation",
//                     absolute_error, "w");
//   FMCA::IO::print2m("error_collocation_relative.m", "relative_error_collocation",
//                     relative_error, "w");
