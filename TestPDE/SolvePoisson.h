/* This header is the solver for the Poisson eqiuation using Samplet Matrix Compression. It returns the 
solution u in samplet basis (not in the natural order!). See PoissonSquareCompressed.cpp for an application */
